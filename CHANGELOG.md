...
- `calendarproject/initializers.py` now exists to define frequently used imports, variables, etc.
...
- `calendarproject/blueprints/` namespace has been removed
...
- Import `Redis` more efficiently in `calendarproject/extensions.py`
...
- Unnecessary `CELERY_TASK_LIST` comment in `calendarproject/app.py`, this was a left over copy / paste mishap
